...
## Environments
- Preview: https://main--itc-foodiesonly--aemysites.aem.page/
- Live: https://main--itc-foodiesonly--aemysites.aem.live/
- Block Library: https://main--itc-foodiesonly--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-foodiesonly` directory in your favorite IDE and start coding :)
